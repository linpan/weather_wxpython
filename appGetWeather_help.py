...
def getCityWeather_RealTime(cityID):  
    ...
    try:  
        ...
        weatherInfomation = stdout.read()         
        wea=eval(weatherInfomation) 
        msg={}
        msg['city']=unicode(wea['weatherinfo']['city'],'utf-8')
        msg['temp']=wea['weatherinfo']['temp']
        msg['wind']=wea['weatherinfo']['WD']
        msg['sd']=wea['weatherinfo']['SD']
        msg['time']=wea['weatherinfo']['time']
...
def convertName(cityName):  
    ...
    if name.find(u"省") !=-1 and len(name)>3:# 包含'省'   
        #print u'有省'  
